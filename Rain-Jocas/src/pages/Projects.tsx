...
const aiProjectDescription = (
  <>
  <p className="px-5 py-4 text-blueBlack">
...
const wordGenDescription = (
  <p className="pt-4 pb-5 px-5 text-blueBlack">This project reads an input text, builds a SequenceTable,
...
const coinGameDescription = (
  <p className="pt-4 pb-5 px-5 text-blueBlack">
